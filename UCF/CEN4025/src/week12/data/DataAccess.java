...
public class DataAccess
{
	 ...
	 *             on error
	 */
	public Account getAccount(long accountId) throws AtmDataException
	{
	...
	public void deleteAccount(Account account) throws AtmDataException
	{
		try
		{
			m_deleteAccountStatement.setLong(1, account.getAccountId());
			m_deleteAccountStatement.execute();
		}
		catch(SQLException ex)
		{
			// log error
	...
	public void connect() throws AtmDataException
	{
		try
		{
			...
			m_deleteAccountStatement = m_connect.prepareStatement(DELETE_ACCOUNT_SQL);
	...
	private PreparedStatement m_deleteAccountStatement;
	...
	private static String DELETE_ACCOUNT_SQL = "DELETE FROM atm.account WHERE id=?";
}
