...
public class JUnitJavadocValidation
{
	public JUnitJavadocValidation()
	{
		...
		// List<ConstructorTestData> fibCconstructors = new
		// ArrayList<ConstructorTestData>();
		...
		// myListCconstructors.add(new ConstructorTestData("EuclidGcd", 0,
		// "public"));
		...
		myAbstractArrayList
				.add(new MethodTestData2("add", "E", "void", "public"));
		myAbstractArrayList
				.add(new MethodTestData2("isEmpty", "", "boolean", "public"));
		myAbstractArrayList
				.add(new MethodTestData2("remove", "E", "boolean", "public"));
		myAbstractArrayList
				.add(new MethodTestData2("set", "intE", "E", "public"));
		myAbstractArrayList
				.add(new MethodTestData2("size", "", "int", "public"));
		...
		myAbstractArrayListCconstructors
				.add(new ConstructorTestData("MyAbstractList", 0, "protected"));
		myAbstractArrayListCconstructors
				.add(new ConstructorTestData("MyAbstractList", 1, "protected"));
		testFiles.add(new FileTestData2("test", "MyAbstractList.java",
				myAbstractArrayList, myAbstractArrayListCconstructors));

		// // Employee.java
		// methods.add(new MethodTestData("equals", 1, "boolean", "public"));
		// methods.add(
		// new MethodTestData("getDisplayName", 0, "String", "public"));
		// methods.add(new MethodTestData("getFirstName", 0, "String",
		// "public"));
		// methods.add(new MethodTestData("getFormattedSalary", 0, "String",
		// "public"));
		// methods.add(new MethodTestData("getLastName", 0, "String",
		// "public"));
		...
		//
		// List<ConstructorTestData> constructors = new
		// ArrayList<ConstructorTestData>();
		...
		// dlMethods.add(new MethodTestData("addEmployee", 1, "void",
		// "public"));
		// dlMethods.add(
		...
		//
		// List<ConstructorTestData> dlConstructors = new
		// ArrayList<ConstructorTestData>();
		// dlConstructors.add(new ConstructorTestData("DataLayer", 1,
		// "public"));
		...
		// blMethods.add(new MethodTestData("changeEmployeeSalary", 2,
		// "boolean",
		// "public"));
		...
		// List<ConstructorTestData> blConstructors = new
		// ArrayList<ConstructorTestData>();
		// blConstructors.add(new ConstructorTestData("CollectionBusinessLayer",
		// 0,
		// "public"));
		// blConstructors.add(new ConstructorTestData("CollectionBusinessLayer",
		// 1,
		// "public"));
		// testFiles.add(new FileTestData("test",
		// "CollectionBusinessLayer.java",
