...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(selectPerson(1));
		for (Person i : findAllPeople()) {
	...
	public static Connection insertPerson(Person person) {
		...
		try {
			...
			String sql = "INSERT INTO PERSON (FIRSTNAME,LASTNAME,AGE,CREDITCARD,SSN) " 
					+ "VALUES (" 
					+ "'" + person.getFirstName() + "'," 
					+ "'" + person.getLastName() + "'," 
					+ person.getAge() + ","
			...
			System.out.println("Person inserted into database: " 
